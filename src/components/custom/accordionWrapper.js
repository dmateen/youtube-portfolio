    ...
    >
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          ...
          clients by clicking here. Feel free to reach out to me there if you
          prefer to collaborate through Upwork.
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-3">
        <AccordionTrigger>
          How do you ensure the scripts align with my channel&apos;s tone and
          style?
        </AccordionTrigger>
        <AccordionContent>
          I start by thoroughly researching your channel and understanding your
          brand voice. We&apos;ll have a detailed discussion about your
          preferences, and I&apos;ll ensure that each script matches the tone,
          style, and audience expectations of your channel.
        </AccordionContent>
      </AccordionItem>
